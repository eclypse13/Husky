...
const news = [
    {
        ...
        excerpt: "В Москве прошла крупнейшая специализированная выставка с участием более 200 собак из 15 стран.",
        featured: true,
        link: "Читать полный отчет",
        icon: "🏆",
        to: "/news/1"
    },
    {
        ...
        tag: "Здоровье",
        date: "15 июля 2025",
        title: "Новые генетические тесты",
        excerpt: "Расширена панель доступных тестов для породы...",
        link: "Подробнее",
        icon: "🧬",
        to: "/news/2"
    },
    {
        ...
        tag: "Спорт",
        date: "12 июля 2025",
        title: "Чемпионат по драйленду",
        excerpt: "Старт летнего сезона ездового спорта...",
        link: "Результаты",
        icon: "❄️",
        to: "/news/3"
    },
    {
        ...
        tag: "Образование",
        date: "10 июля 2025",
        title: "Семинар для судей",
        excerpt: "Обучающий семинар по породе...",
        link: "Регистрация",
        icon: "🎓",
        to: "/news/4"
    },
    {
        ...
        tag: "Достижения",
        date: "8 июля 2025",
        title: "Новые чемпионы",
        excerpt: "Поздравляем владельцев собак...",
        link: "Список",
        icon: "🌟",
        to: "/news/5"
    },
                        ...
                        <>
                            ...
                            <div className="home-map-kennel-list">
                                {selectedStats.kennels.map((kennel, index) => (
                                    <div className="home-map-kennel-item"
                                         key={`${kennel.name_rus || "kennel"}-${index}`}>
                                        <div className="home-map-kennel-title-row">
                                            <div
                                                className="home-map-kennel-name">{kennel.name_rus || "Без названия"}</div>
                                        ...
                                        {kennel.website && (
                                            <div className="home-map-contact-line">
                                                <a href={kennel.website} target="_blank"
                                        ...
                                        {kennel.vkGroup && (
                                            <div className="home-map-contact-line">
                                                <a href={kennel.vkGroup} target="_blank"
                                                   rel="noopener noreferrer">вк</a>
                                            </div>
                                        )}

                                        {kennel.telegramGroup && (
                                            <div className="home-map-contact-line">
                                                <a href={kennel.telegramGroup} target="_blank"
                                                   rel="noopener noreferrer">телеграм</a>
                                            </div>
                                        )}
...
export default function Home() {
    ...
    useEffect(() => {
        fetch("/api/dogs/hero/")
            .then(r => r.ok ? r.json() : null)
            .then(data => setHeroDog(data ?? null))
        ...
        <div className="home-page">
                ...
                <div className="home-hero-content">
                    <div className="home-hero-text">
                        ...
                        <p className="home-hero-subtitle">
                            Ведущий национальный клуб России, объединяющий заводчиков, владельцев и любителей породы
                            сибирский хаски.
            ...
            <section className="home-features">
                <div className="home-features-content">
                    <div className="home-head-section-header">
                        ...
                        <p className="home-head-section-subtitle">Комплексная экосистема для заводчиков, владельцев и
                            любителей сибирских хаски</p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "15,000+ собак в базе данных с интерактивными родословными, результатами тестов здоровья и полной историей титулов.",
                            ...
                            },
                            {
                                ...
                                desc: "Генетические тесты, офтальмологические обследования, реестры здоровья и инструменты для планирования вязок.",
                                link: "Тестирование",
                                to: "/health"
                            },
                            {
                                icon: "🏆",
                                title: "Выставки и спорт",
                                desc: "Календарь мероприятий, результаты выставок, ездовой спорт, семинары и обучающие программы.",
                                link: "Мероприятия",
                                to: "/events"
                            },
                            {
                                icon: "🤝",
                                title: "Сообщество",
                                desc: "Объединяем заводчиков и владельцев, обмениваемся опытом, поддерживаем новичков и развиваем породу вместе.",
                                link: "Присоединиться",
                                to: "/about"
                            },
                            {
                                ...
                                desc: "AI-анализ совместимости, предиктивная аналитика наследственных заболеваний, компьютерное зрение для оценки экстерьера.",
                                link: "Инновации",
                                to: "/tools"
                            },
                            {
                                icon: "🌐",
                                title: "Интеграция",
                                desc: "Партнерство с breedarchive.com, обмен данными с ведущими клубами мира, участие в глобальных проектах.",
                                link: "Узнать больше",
                                to: "/about"
                            },
                        ].map(f => (
            ...
            <section className="home-features">
                <div className="home-features-content">
                    <div className="home-head-section-header">
                        ...
                        <p className="home-head-section-subtitle">Помёты от проверенных питомников — только от членов
                            НКП.</p>
                    </div>
            ...
            <section className="home-cta-section">
                <div className="home-cta-content">
                    ...
                    <p className="home-cta-subtitle">Станьте частью сообщества, которое формирует будущее породы
                        сибирский хаски в России.</p>
