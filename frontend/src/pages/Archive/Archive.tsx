                ...
                <div className="archive-container">
                    ...
                    <section className="archive-results-grid">
                                    ...
                                    <article key={d.id} className="archive-dog-card">
                                        ...
                                        <div className="archive-dog-info">
                                            ...
                                            <div className="archive-dog-meta">
                                                ...
                                                {d.color && <span
                                                    className="archive-dog-meta-item capitalize-text">{d.color}</span>}
                        ...
                        <aside className="archive-sidebar">
                            ...
                            <a href="https://siberianhusky.breedarchive.com/home/index" className="archive-partner-link"
