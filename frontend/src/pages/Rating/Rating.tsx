        ...
        <>
            {Array.from({length: 5}).map((_, i) => (
                <tr key={i} className="rt-tr rt-tr--skel" aria-hidden>
                    <td>
                        <div className="rt-skel" style={{width: 28, height: 28, borderRadius: "50%"}}/>
                    </td>
                    <td>
                        <div className="rt-skel" style={{width: 40, height: 40, borderRadius: "50%"}}/>
                    </td>
                    <td>
                    ...
                    <td>
                        <div className="rt-skel" style={{width: 48, height: 18}}/>
                    </td>
                    <td/>
                </tr>
            ))}
